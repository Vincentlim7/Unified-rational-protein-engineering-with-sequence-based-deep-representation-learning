...
classes_avg = np.load("database/data_avg1990.npy")[()]
classes_concat = np.load("database/data_concat1990.npy")[()]
...
np.save("database/data_avg2882.npy", classes_avg)
np.save("database/data_concat2882.npy", classes_concat)
