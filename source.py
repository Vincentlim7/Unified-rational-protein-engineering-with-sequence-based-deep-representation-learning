...
classes_avg = np.load("database/data_avg9630.npy")[()]
classes_concat = np.load("database/data_concat9630.npy")[()]
...
np.save("database/data_avg9630.npy", classes_avg)
np.save("database/data_concat9630.npy", classes_concat)


# In[ ]:


print(classes_avg["c.51.4.1"])
